...
//    private final BranchProductRepository branchProductRepository;
    ...
    public ResponseData getRandomProduct() {
        try {
            ...
            List<ProductDetailDTO> randomProducts = products.stream()
                    .limit(100)
                    .toList();
    ...
    public ResponseData findProductById(Long id) {
        try{
//            Optional<BranchProduct> branchProductOptional = branchProductRepository.findByBranchIdAndProductId(1L, id);
//            if (branchProductOptional.isEmpty()) {
//                return ResponseData.error("No branch product created yet");
//            }
//
//            return ResponseData.success("Fetched product successfully", toProductDetailDTO(branchProductOptional.get()));
